...
if (isset($_SESSION['client_name'])) {
  $admin_name = $_SESSION['client_name'];
} else {
    ...
    <div class="row gx-0 d-none d-lg-flex">
      ...
      <div class="col-lg-5 px-5 text-end">
        <div class="h-100 d-inline-flex align-items-center py-3 me-4">
          ...
          <small>0812718969</small>
        </div>
        <div class="h-100 d-inline-flex align-items-center">
          <a
            class="btn btn-sm-square rounded-cirncle bg-white text-primary me-1"
  ...
  <nav
    ...
    <a
      ...
      <h1 class="m-0 text-primary">
        <i class="far fa-hospital me-3"></i>C.C SUPPORT
      </h1>
    </a>
    <button
      type="button"
    ...
    <div><?php echo 'We are here for you, <span style="color:Blue; font-weight:bold;">' . $admin_name . '</span> 💪💖✨'; ?></div>

    <div class="collapse navbar-collapse" id="navbarCollapse">
      <div class="navbar-nav ms-auto p-4 p-lg-0">
        <a href="index.php" class="nav-item nav-link active">Home</a>
        <a href="Medications.php" class="nav-item nav-link">Medications</a>
        <a href="appointment.php" class="nav-item nav-link">Appoinments</a>
      ...
      <div class="row g-4">
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
          <div class="service-item bg-light rounded h-100 p-5">
            ...
            <h4 class="mb-3">Accommodation Facilities</h4>
            <p class="mb-4">
              We provide secure, comfortable accommodations near treatment
              centers, allowing patients and families to stay close together
              during care.
            </p>
        ...
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
          <div class="service-item bg-light rounded h-100 p-5">
            ...
            <p class="mb-4">
              Our counselling services offer emotional and psychological
              support, helping patients and families navigate the challenges
              of cancer treatment with professional guidance.
            </p>
            <a class="btn" href="service.html"><i class="fa fa-plus text-primary me-3"></i>Read More</a>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
          <div class="service-item bg-light rounded h-100 p-5">
            ...
            <h4 class="mb-3">Home Visit Programs</h4>
            <p class="mb-4">
              Healthcare professionals provide personalized care at home for
              patients unable to travel, ensuring continuous support and
              medical attention in a familiar setting.
            </p>
            <a class="btn" href="service.html"><i class="fa fa-plus text-primary me-3"></i>Read More</a>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
          <div class="service-item bg-light rounded h-100 p-5">
            ...
            <h4 class="mb-3">Affordable Cancer Medications</h4>
            <p class="mb-4">
              We offer essential cancer medications at the lowest possible
              prices, making life-saving treatments accessible to all,
        ...
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
          <div class="service-item bg-light rounded h-100 p-5">
            ...
            <h4 class="mb-3">Cancer Awareness Programs</h4>
            <p class="mb-4">
              Our programs educate the public on cancer prevention, early
              detection, and treatment, promoting awareness and reducing
              stigma through proactive health initiatives.
            </p>
            <a class="btn" href="service.html"><i class="fa fa-plus text-primary me-3"></i>Read More</a>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
          <div class="service-item bg-light rounded h-100 p-5">
            ...
            <h4 class="mb-3">Clinical Trial</h4>
            <p class="mb-4">
              Clinical trials are research studies that test new treatments to
              see how well they work. At MSK, we are running one of the
              largest clinical trials programs for cancer in the country.
            </p>
            <a class="btn" href="service.html"><i class="fa fa-plus text-primary me-3"></i>Read More</a>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row g-5">
        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
          ...
          <p class="mb-4">
            Schedule a visit with our experienced doctor to discuss your needs
            and receive personalized care. Contact us today to book your
            appointment and take the first step towards comprehensive support
            and treatment. We look forward to assisting you.
          </p>
          ...
          <div class="bg-light rounded d-flex align-items-center p-5">
            ...
            <div class="ms-4">
              ...
              <h5 class="mb-0">mnabd964@gmail.com</h5>
            </div>
          </div>
        </div>
    ...
    <div class="container py-5">
      <div class="row g-5">
        <div class="col-lg-3 col-md-6">
          ...
          <p class="mb-2">
            <i class="fa fa-map-marker-alt me-3"></i>132/A dawlagala handessa
          </p>
          <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>0812758665</p>
          <p class="mb-2">
            <i class="fa fa-envelope me-3"></i>mnabd964@gmail.com
          </p>
        ...
        <div class="col-lg-3 col-md-6">
          ...
          <p>
            Subscribe for updates on cancer care, support services, and expert
            insights.
          </p>
